...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 align="center" style="font-size: 38px;color: #c9302c">登录界面</h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form role="form" id="form1" action="<c:url value="/login"/>" method="post">
                        <div class="form-group">
                            <label for="exampleInputEmail2">用户名</label>
                            <input type="text" name="username" class="form-control" id="exampleInputEmail2" placeholder="请输入您的用户名，长度6-12位" maxlength="13" >
                        </div>
                        <p id="p1" style="color: red"></p>
                        <div class="form-group">
                            <label for="exampleInputPassword2">密码</label>
                            <input type="password" name="password" class="form-control" id="exampleInputPassword2" placeholder="请输入您的密码，长度6-12位" maxlength="13">
                        </div>
...
<script>
    ...
    function finallyCheck() {
        ...
        if (!nameAndPassCheck(document.getElementById("exampleInputPassword2").value,"p2","密码")) {
            point -= 1;
        }
