            ...
            <div class="row" style="margin-top: 20px">
                ...
                <div class="col-md-4">
                    <button onclick="window.location.href='<c:url
                            value="/user/showRecruitment?pageId=1"/>'" class="btn btn-primary"
                            style="margin-left: 3%;padding-left: 10px;padding-right: 10px">首页
                    </button>
                    <c:if test="${pageId != 1}">
                        <button onclick="window.location.href='<c:url
                                value="/user/showRecruitment?pageId=${pageId-1}"/>'"
                    ...
                    <c:if test="${(pageId)<pageIdMax}">
                        <button onclick="window.location.href='<c:url
                                value="/user/showRecruitment?pageId=${pageId+1}"/>'" class="btn btn-primary"
                                style="margin-left: 3%">${pageId+1}</button>

                        <c:if test="${(pageId+1)<pageIdMax}">
                            <button onclick="window.location.href='<c:url
                                    value="/user/showRecruitment?pageId=${pageId+2}"/>'" class="btn btn-primary"
                                    style="margin-left: 3%">${pageId+2}</button>

                            <c:if test="${(pageId+2)<pageIdMax}">
                                <button onclick="window.location.href='<c:url
                                        value="/user/showRecruitment?pageId=${pageId+3}"/>'" class="btn btn-primary"
                    ...
                    <button onclick="window.location.href='<c:url
                            value="/user/showRecruitment?pageId=${pageIdMax}"/>'" class="btn btn-primary"
